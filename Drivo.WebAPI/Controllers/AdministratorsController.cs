...
public class AdministratorsController : ControllerBase
{
    ...
    [HttpGet("{userName}")]
    public async Task<ActionResult<AdministratorEntity>> GetAdministratorByUserName([FromRoute] string userName)
    {
    ...
    public async Task<ActionResult<ActionResponse>> CreateAdministrator([FromBody] CreateUserRequest request)
    {
    ...
    [HttpDelete("{userName}")]
    [Authorize(Roles = "Administrator")]
    public async Task<ActionResult<ActionResponse>> DeleteAdministrator([FromRoute] string userName)
    {
