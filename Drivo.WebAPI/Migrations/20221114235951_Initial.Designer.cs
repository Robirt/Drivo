...
namespace Drivo.WebAPI.Migrations
{
    ...
    [Migration("20221114235951_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drivo.Entities.DrivingEntity", b =>
                {
                    ...
                    b.Property<double>("CurrentNumberOfHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Drivo.Entities.LectureEntity", b =>
                {
                    ...
                    b.Property<int?>("StudentsGroupEntityId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("StudentsGroupEntityId");
            ...
            modelBuilder.Entity("Drivo.Entities.LectureEntity", b =>
                {
                    b.HasOne("Drivo.Entities.StudentsGroupEntity", null)
                        .WithMany("Lectures")
                        .HasForeignKey("StudentsGroupEntityId");
                });

            modelBuilder.Entity("Drivo.Entities.PaymentEntity", b =>
                {
                    b.HasOne("Drivo.Entities.StudentEntity", null)
                        .WithMany("Payments")
