...
const routes: Routes = [
  ...
  { component: StudentsGroupsComponent, path: "StudentsGroups", canActivate: [IsAuthenticatedGuard, IsInRoleGuard], data: { roles: ['Administrator'] } },
  { component: InstructorsComponent, path: "Instructors", canActivate: [IsAuthenticatedGuard] },
  { component: InstructorComponent, path: "Instructors/:userName", canActivate: [IsAuthenticatedGuard, IsInRoleGuard], data: { roles: ['Administrator'] } },
